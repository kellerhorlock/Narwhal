...
export default function NotFound() {
  return (
    <div className="flex min-h-screen flex-col items-center justify-center" style={{ background: "var(--bg-deep)" }}>
      <NarwhalIcon size={120} style={{ color: "var(--text-muted)" }} animate="float" className="mb-6" />
      <h1 className="text-3xl font-bold tracking-tight mb-2" style={{ color: "var(--text-primary)" }}>Lost at sea?</h1>
